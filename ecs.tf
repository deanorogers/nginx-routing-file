...
resource "aws_ecs_task_definition" "nginx-service-a" {
  ...
  execution_role_arn = "arn:aws:iam::107404535822:role/ecsTaskExecutionRole"
  # execution_role_arn = "arn:aws:iam::107404535822:role/MyAmazonECSServiceRole"
  # Needed to read Secret
  # execution_role_arn = "arn:aws:iam::107404535822:role/nginxRouterEcsCodeDeployRole"
  network_mode = "awsvpc"
  cpu = 1024 
  memory = 2048
  container_definitions = jsonencode([
    {
      ...
      image     = "107404535822.dkr.ecr.eu-west-1.amazonaws.com/nginx-service-a:latest"
      essential = true      
      portMappings = [
        {
          containerPort = 8081
  ...
  container_definitions = jsonencode([
    {
      ...
      image     = "107404535822.dkr.ecr.eu-west-1.amazonaws.com/nginx-router:latest"
      essential = true
      portMappings = [
        {
          containerPort = 8080
  ...
  container_definitions = jsonencode([
    {
      ...
      image     = "107404535822.dkr.ecr.eu-west-1.amazonaws.com/nginx-service-b:latest"
      essential = true
      portMappings = [
        {
          containerPort = 8082
